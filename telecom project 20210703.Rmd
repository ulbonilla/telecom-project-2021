...
path <- "//MyCloudEX2Ultra/HDulises/backup1/trabajo/IFT/cursos/EDX/harvard x/edx data science capstone/telecom"
...
kaggler::kgl_auth(creds_file = str_c(path,'/kaggle.json'))
...
Next, i wxplore the numercal variables. The following diagrams are histograms of the numeric variables, excluding `SeniorCitizen`.
